<template>
  <div class="px-4">
    <form class="flex flex-wrap justify-between  w-full" @submit.prevent="buscaDadosServidorOrgao">
      <div class=" my-4 flex  items-center">
        <div class="flex items-center">
          <label class="mx-1 block text-gray-800 font-bold text-left" for="CPF">CPF:</label>
          <input class="form-input rounded py-1" id="CPF" type="text" v-model="cpf">
          <button class="mx-4 bg-green-600 px-4 py-2 rounded inline-flex items-center">
    ...
    <div class="w-full overflow-x-auto relative my-4">
